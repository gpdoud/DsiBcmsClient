...
export class AttendanceService {
  ...
  report(cohortId, fromDate, toDate): Observable<AttendanceReport[]> {
    return this.http.get(`${this.sys.url}/attendances/report/${cohortId}/${fromDate}/${toDate}`) as Observable<AttendanceReport[]>;
  }
